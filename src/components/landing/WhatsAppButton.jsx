      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl border border-border px-4 py-3 flex items-center gap-3 max-w-[220px]"
          >
            <p className="text-xs font-body text-foreground leading-snug">
              💬 Besoin d'un devis rapide ? Écrivez-nous sur WhatsApp !
            </p>
            <button
